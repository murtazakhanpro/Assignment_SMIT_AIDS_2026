...
| Batch | 2026 |
| Instructor | Janab Sir Nasir Hussain |
| Author | Murtaza Ali |
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/<your-username>/SMIT-Assignments-AIDS-2026.git
...
Suggestions and constructive feedback are welcome as this learning repository continues to grow.
